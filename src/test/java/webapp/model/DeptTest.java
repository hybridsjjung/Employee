...
public class DeptTest {
	...
	public void test1_String() {
		...
		log.info("s1 == s2 : " + (s1 == s2)); //false (레퍼런스 비교)
		log.info("s1.equals(s2) : " + s1.equals(s2)); //true (값 비교)
	}
	...
	public void test2_Dept() {
		...
		log.info("d1 == d2 : " + (d1 == d2)); //false
		log.info("d1.equals(d2) : " + d1.equals(d2)); //true
	}
