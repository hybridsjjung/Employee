...
public class DataSourceTest {
	...
	static Log log = LogFactory.getLog(DataSourceTest.class);	//commons log
	
	@Autowired
	ApplicationContext factory;	// 필드 주입
	
	@Test
	public void testDriverManagerDataSource() throws SQLException {	// beans.xml
